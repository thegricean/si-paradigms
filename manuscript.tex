...
children to give a small, big, or huge strawberry to a puppet depending on
\enquote{how good the puppet said it}. The result was that children gave
the mid-size strawberry to the puppet when he produced
...
suggests two things: first, that whatever participants are doing in a
...
implicature rates than the strong link. Finally, there was a three-way interaction between
